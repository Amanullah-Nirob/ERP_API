...
if (isset($_POST['submit']) && isset($_FILES['my_image'])) {
    ...
    $query = "INSERT INTO  tele_partner (employee_name,designation,salary,email,phone,address,birthday,employee_image) 
       ...
       if(mysqli_query($db,$query)){
        echo json_encode(array("message" => "tele partner employee details was created."));
}else{
        echo json_encode(array("message" => "tele partner employee details not created."));
