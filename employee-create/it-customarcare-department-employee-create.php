...
if (isset($_POST['submit']) && isset($_FILES['my_image'])) {
    ...
    $query = "INSERT INTO  it_customarcare_department_employee_read (employee_name,designation,salary,email,phone,address,birthday,employee_image) 
       ...
       if(mysqli_query($db,$query)){
        echo json_encode(array("message" => "it department employee details was created."));
        header("Location: https://testerp.apodigi.com/dashboard/cutomerCareDepartment");
}else{
        echo json_encode(array("message" => "it department employee details not created."));
