...
if (isset($_POST['submit']) && isset($_FILES['my_image'])) {
    ...
    $db = $database->getConnection();
      ...
      //  echo "</pre>";
       ...
       if ($error === 0) {
         ...
         // image_url='https://testerp.apodigi.com/erpApi/uploads/$new_img_name'
    ...
    $query = "INSERT INTO  bd_department_employee_read (employee_name,designation,salary,email,phone,address,birthday,employee_image) 
       ...
       if(mysqli_query($db,$query)){
        ...
        header("Location: https://testerp.apodigi.com/dashboard/BdDepartment");
}else{
