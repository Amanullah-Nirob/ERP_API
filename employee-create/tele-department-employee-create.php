...
if (isset($_POST['submit']) && isset($_FILES['my_image'])) {
    ...
    $query = "INSERT INTO tele_department_employee_read (employee_name,designation,salary,email,phone,address,birthday,employee_image) 
       ...
       if(mysqli_query($db,$query)){
        ...
        header("Location: https://testerp.apodigi.com/dashboard/teleDepartment");
}else{
